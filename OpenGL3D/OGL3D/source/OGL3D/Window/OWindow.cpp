...
OWindow::OWindow()
{
	...
	m_handle = CreateWindowEx(NULL, MAKEINTATOM(ClassId), L"Prizrakss | OpenGl 3D Game", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU,
	...
	//Создание OpenGL Render Context
...
void OWindow::makeCurrentCntext()
{
